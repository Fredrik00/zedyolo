...
(cl:defmethod cl:initialize-instance :after ((m <Prediction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Prediction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_dnn_msgs-msg:<Prediction> is deprecated: use ros_dnn_msgs-msg:Prediction instead.")))

(cl:ensure-generic-function 'classes-val :lambda-list '(m))
(cl:defmethod classes-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_dnn_msgs-msg:classes-val is deprecated.  Use ros_dnn_msgs-msg:classes instead.")
  (classes m))

(cl:ensure-generic-function 'probabilities-val :lambda-list '(m))
(cl:defmethod probabilities-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_dnn_msgs-msg:probabilities-val is deprecated.  Use ros_dnn_msgs-msg:probabilities instead.")
  (probabilities m))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_dnn_msgs-msg:xmin-val is deprecated.  Use ros_dnn_msgs-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'ymin-val :lambda-list '(m))
(cl:defmethod ymin-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_dnn_msgs-msg:ymin-val is deprecated.  Use ros_dnn_msgs-msg:ymin instead.")
  (ymin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_dnn_msgs-msg:xmax-val is deprecated.  Use ros_dnn_msgs-msg:xmax instead.")
  (xmax m))

(cl:ensure-generic-function 'ymax-val :lambda-list '(m))
(cl:defmethod ymax-val ((m <Prediction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_dnn_msgs-msg:ymax-val is deprecated.  Use ros_dnn_msgs-msg:ymax instead.")
  (ymax m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Prediction>)))
  ...
  (cl:format cl:nil "string[] classes~%float64[] probabilities~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Prediction)))
  "Returns full string definition for message of type 'Prediction"
  (cl:format cl:nil "string[] classes~%float64[] probabilities~%int64 xmin~%int64 ymin~%int64 xmax~%int64 ymax~%~%~%"))
