...
"""autogenerated by genpy from ros_dnn_msgs/DetectActionFeedback.msg. Do not edit."""
import sys
...
class DetectActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "ros_dnn_msgs/DetectActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ros_dnn_msgs/DetectFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DetectActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ros_dnn_msgs.msg.DetectFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ros_dnn_msgs.msg.DetectFeedback()
