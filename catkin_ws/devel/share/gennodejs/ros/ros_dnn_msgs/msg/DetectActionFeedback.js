...
let DetectFeedback = require('./DetectFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class DetectActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new DetectFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DetectFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DetectActionFeedback(null);
    ...
    data.feedback = DetectFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DetectActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = DetectFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new DetectFeedback()
    }
...
module.exports = DetectActionFeedback;
